...
public class Array04 {
    ...
    // 입력 관련 method 정의
    public void writesElements(String[]/*저장공간*/ strArray/*매개변수명*/) {
        // 여기서 스캐너를 import 하고, 매개변수로 받은 배열에
        // 값을 입력할 수 있도록 하는 method 정의
    ...
    public static void main(String[] args) {
        Array04 array04 = new Array04(); // 메서드 정의영역을 사용하기 위해 불러오는거
        // 임의의 String[] 배열 생성
//        String[] people/*선언명*/ = new String[5];
//        // 메서드 호출 영역
