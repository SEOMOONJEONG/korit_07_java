...
//        System.out.println(arr01[4]);
        ...
        "안녕하세요".length();
        // 근데 우리가 필드를 참조할 때 객체명.필드(arr01.length) 형태로 참조했었습니다.
        ...
        // 이상의 모든 것을 종합했을 때,
        // 배열 내부의 방의 개수 / 주서지의 한계값 - 1 을 우리가 항상 알고있는 것은 아니기 때문에
        // element 값을 출력하기 위한 반복문의 한계값을 설정 할 때
        // 배열명.length를 쓰는 것을 생활화하자.

        // arr01 내부에 있는 1, 2, 3, 4, 5는 굳이 따지자면 arr01[0], arr01[1], ..., arr01[4]라는 변수명을
        // 지니고 있다고 볼 수 있습니다.

        // 변수의 개념을 우리는 다시 생각해야 합니다.
        System.out.println();
        arr01[0] = 10;      // 그럼 얘는 재대입 해야겠네요.
        System.out.println(arr01[0]);       // 결과값 : 10

        // 그럼 우리는 배열에 값을 대입할 수 가 있습니다.
        ...
        System.out.println();
        // arr02에 현재 21, 22, 23, ..., 30 이 대입되어 있습니다.
