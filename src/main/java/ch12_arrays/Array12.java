...
/*
    ...
    여기서 중요한 점은 동일한 method 명이라고 하더라도 어떤 클래스에 종속되어있는 가에 따라
...
//        System.out.println(num2);
        ...
        // 배열 전체 출력 예시
        System.out.println(Arrays.toString(numbers));   // Arrays = 클래스 (추후 수업 예정)

        Method01.call1(); // [ x | x ]
        System.out.println(Method01.call3());   // [ x | o ] \n안녕하세요
        ...
        /*
            ...
            내림 차순 할 때는 보니까 argument가 두 개입니다.
            ...
            두 번째 argument로 사용되었다는 점에서 역시 함수형 프로그래밍의 일종이라고 볼 수 있겠네요.
