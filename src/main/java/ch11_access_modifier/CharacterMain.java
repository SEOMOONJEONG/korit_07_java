...
/*
    ...
    이를 CharacterMain클래스에서 기능 테스트를 수행할겁니다.
...
class Character {
    ...
    public void attack() {
        ...
        // 획득하는 버그는 막고싶어요. 그렇다면 위의 가이드에서 작성했던 gainExp()는 외부에서 실행되면 안됩니다.
        this.gainExp(30);
    }
...
public class CharacterMain {
    public static void main(String[] args) {
        ...
        // 객체의 필드에 값 대입
//        warrior.name = "전사";        // field가 public이기 때문에 타 클래스(CharacterMain)에서 값을 직접 대입사는 것이 가능
//        warrior.setName("전사");           // 이상의 직접 대입 방식과의 코드 작성 차이점에 대해서 확인하시기 바랍니다.
//        warrior.setHealth(100);
//        warrior.setPower(200);
//        warrior.setSkill("세로베기");
//        warrior.setExp(30);
        System.out.println(warrior.getHealth());    // 생성자 내부의 초기 필드에 정의 시켰기때문에
...
/*
    ...
    그렇기 때문에 getter을 통한 닉네임의 호출은 필요가 없어서
    이상의 코드에서 getName() 메서드는 쓸모가 없을겁니다.

    우리는 어떤 클래스/필드/메서드를 어떤 접근지정자를 설정해야 할지도 고민해야겠습니다.

    하지만 현재 수업 상황에서는 웬만하면 필드는 private으로 설정,
    getter / setter를 통한 우회 설정 및 조회를 목표로 하겠습니다.
 */
