...
public class Bank {
    ...
    public void setBalance(int balance) {
        ...
        this.balance = balance; //  이거 초기 잔액 세팅이기 떄문에 입금을 얘로 이루어 질 수 x
    }
    ...
    public void deposit(int amount, int inputPin) {
        if(inputPin != pinNumber){
            ...
            return;
        }else { // inputPin == pinNumber && amount > 0
            balance += amount;
