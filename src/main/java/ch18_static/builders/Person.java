...
public class Person {
    ...
    private Person(Builder builder) { // 하단 코드 미완시 오류
    ...
    /*
        ...
        builder 객체의 필드로 name / age / address가 있는것으로 보입니다.
        여기서 중요한 점은 Person의 필드와 Builder의 피드가 동일해야 한다는 겁니다.
     */
    ...
    public static class Builder {
        ...
        public Builder name(String name) {
            ...
            return this;        // 여태까지는 name에 값이 없다가,
            // 40번 코드라인 시점에 name field에 값이 대입된 객체가 리턴됨.
        }

        public Builder age(int age) {   // return이 붙었기 때문에 void x
            this.age = age;
            return this;
        }
