...
/*
    ...
    그럼 Excpetion01에서 알 수 있듯이, 다수의 예외의 경우에는 이미 개발자들이 정의를 해놓았습니다.
...
public class Exception01 {
    public static void main(String[] args) {
        ...
        person1.name = "김일";
        person1.age = 20;
//        person1.school = "코리아아이티";            IDE 상에서 예외처리가 아니라 뻘겋게 나오는 예시 # 1
        person1.showInfo();
//        person1.displayInfo();                    IDE 상에서 예외처리가 아니라 뻘겋게 나오는 예시 # 2
...
//        int b = 0;
//        try {
//            int result = a / b;     // ArithmeticException 예외 발생 지점 → 38번 라인이 아니라 catch문으로 넘어갑니다.
