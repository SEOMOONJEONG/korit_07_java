...
//        char casted5 = cast5;
        /*
            ...
            (아까 강남스타일을 예시로 들었을 때 38억이 넘는 숫자를 다시 int로 형변환하게 되면 마이너스 값이 나오게 되겠죠)
        ...
        System.out.println("원형 : " + casted5);

        /*
            int가 21억 정도까지의 범위인데 더 큰 숫자로 표기하기 위해서는
            정수 기준으로 long    → SQL 문에서는 그 와중에 long이 아니라 bigint라고 합니다.
         */
