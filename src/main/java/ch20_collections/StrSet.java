...
public class StrSet {
    public static void main(String[] args) {
        ...
        System.out.println("원래 List : " + strList);    // 원래 List는 그대로 유지
        System.out.println("Set + List element : " + strSet);     // Set에 element들이 더해지긴 했는데,
        ...
        System.out.println(modifiedStrList);
        // set의 순서와 동일하게 들어갔기 떄문에 마찬가지로 순서가 보장되지 않습니다.
        Collections.sort(modifiedStrList);
        System.out.println(modifiedStrList);

        // 그럼 이제는 list니까 요소를 추츨해서 뒤에 " 언어"라고 붙일 수 있겠네요.
        /*
            실행 예
            React 언어
            TypeScript 언어
