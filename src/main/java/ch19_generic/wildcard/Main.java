...
public class Main  {
    // 메서드 정의 영역
    // 현재 AnimalData에서는 필드로 들어온 객체가
    // Animal 클래스의 서브 클래스인지 아닌지를 구분할 수 없기 때문에
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            Generic 개념 때문에, T에는 어떤 클래스도 들어갈 수 있기 떄문입니다.
         */
        animalData1.showData();
        animalData2.showData();
//        animalData3.showData();       // 오류 발생
        /*
            animalData3.showData() 에서 오류가 발생함을 알 수 있ㅅ브니다.
            AnimalData 클래스에서 정의된 메서드 로직을 확인해 보시면
            필드를 (Animal)로 형변환 시키는데, Car 클래스와 신스턴스를  Animal로
            형변환 시키는 것이 불가능하기 때문입니다.

            즉 제네릭'만'을 사용했을 때 생길 수 있는 문제점입니다.
         */
        ...
        /*
            ...
            근데 저희는 대충 아니까 animalData6의 필드에는 뭐가 들어가 있어야 하나요?
         */
        if(animalData4 != null) {
