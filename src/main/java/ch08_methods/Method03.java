...
public class Method03 {
    ...
    public static String getStar(){
        ...
        int rows = 0;       // Method02에는 rowsOfStars 썼지 않나요?
                            // → 근데 getStar()에서 매개변수를 rows로 써서 수정하기 귀찮아서 그냥 이렇게 씁니다.
        int option = 0;
...
//        System.out.println(starResult);
        ...
        System.out.println(getStar());          // 메서드 호출 결과물 print
    }
}
