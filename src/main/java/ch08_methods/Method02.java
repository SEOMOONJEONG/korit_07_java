...
/*
    별찍기 관련한 부분을 저희가 메서드 시켜보도록 하겠습니다.
 */
public class Method02 {

    // call4() 유형으로 작성할겁니다. 왜? → 몇 줄 짜리인지 / 어떤 유형의 별찍기인지를 main에서 받을 예정이기 때문에
    public static String getStar(int rows, int option) {
        // 매서드 내에서만 사용하는 지역 변수(local variable) 선언 및 초기화
        String result = "";
    ...
    public static void main(String[] args) {
        ...
        /*
            ...
            낯설게 느껴지기 보다는 원리를 이해하는 과정이라고 받아들여주시면 좋겠습니다.
         */
