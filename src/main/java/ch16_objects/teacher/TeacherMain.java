...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        // 이상의 코드에서 중요한 점은 재정의 전과 후가 결과값이 다르다는 것입니다.
        // Teacher에서 .equals()를 재정의 하기 전에는 false가 떴었습니다.
        // 그 때의 경우는 teacher1과 teacher2의 주소지까지를 확인하여
        // 같은지 아닌지의 여부를 판단했다면,
...
//        System.out.println(fields); // 주소지 출력됨
        ...
        for( int i = 0; i < methods.length; i++) {
            System.out.println("메서드 명 출럭 : " + methods[i].getName());
        ...
        System.out.println("result2 : " + result2);         // 결과값 : false
