...
//        System.out.println(안녕하세요, 제 이름은 안근수입니다.); // 오류 발생
        ...
        /*
            java에서의 변수 명명 규칙 :
                1. 카멜 표기법(camel case) 사용
                    ...
                    ex) 한 단어 자리 : result
                    ex) 특수 단어 : myTestResult
                2. 특수문자 지양

                     cf) python 학습하신 분들의 경우 python 면수 표기 방식은 스네이크 표기법
        ...
        /*
            ...
            원하는 방식으로 출력되지 않습니다. 144732로 출력됐죠.
            ...
            라고 알아두시면 되겠습니다.
            (근데 python이랑 JavaScript에서는 또 이런 구분이 없습니다.)
        ...
        int width11 = 100;
        int width12 = 200;
        System.out.println(width11 + width12);  // 숫자 변수는 연산이 가능합니다.
        String width3 = "300";
        String width4 = "400";
        ...
        /*
            ...
            제 전공은 ?? 학과이며, mbti는 ?? 입니다. 열심히 하겠습니다.'
        ...
        // sout 두 번 써서 개행하는 방법
        System.out.println("저는 코리아 it 아카데미 7월 국비과정을 수강하고있는 " + name10 + "입니다. " + age10
                + "살 입니다.");
        System.out.println("제 전공은 " + major10 + " 학과이며, mbti는 " + mbti10 + "입니다. 열심히 하겠습니다.");
