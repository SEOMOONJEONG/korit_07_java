...
/*
    ...
    call1() - call4()로, 매개변수 유무 / return 유무로 구분했습니다.
...
public class ReviewMethod {
    ...
    // ★★★★★ 메서드 명은 동일하지만 매개변수의 자료형은 다르다. ★★★★★
    public void writeSchedule(int date, String content){
        System.out.println(date + "일의 스케줄은 다음과 같습니다.");
        System.out.println(content);
    }
    // 2. call2() 유형으로 작성할겁니다. → main에 어떻게 쓸지, 아닐지를 고민해야하죠.
    ...
    public void dividedBySeven(int num){
        ...
        String answer = "";
        if(num % 7 == 0){
            answer = "7의 배수입니다."; // 아마 대부분 여기에 sout을 쓰셨을것 같아서 이렇게 풀이합니다.
        }else {
            answer = "7의 배수가 아닙니다.";
        }
    ...
    // 3. overloading을 통해서 call1() 유형으로도 만들어보세요.
    public void dividedBySeven(){
        Scanner scanner = new Scanner(System.in);
        System.out.print("임의의 숫자를 입력하세요 >> ");
        int num = scanner.nextInt();        // 이거 method의 return값이 num 이라는 변수에저장되는 것이다.
//        String answer = "";
//        if(num % 7 == 0){
//            answer = "7의 배수입니다."; // 아마 대부분 여기에 sout을 쓰셨을것 같아서 이렇게 풀이합니다.
//        }else {
...
//        System.out.println(num + "(은)는 " + answer);
    ...
    public static void main(String[] args) {
        ...
        // dividedBySeven()의 call2()유형은 7의 배수인지 아닌지만 체크합니다.
        // 르기로 argument가 필수적으로 요구되기 때문에
        // main에서 Scanner를 import해야 합니다.
//        Scanner scanner = new Scanner(System.in);
//        System.out.print("임의의 숫자를 입력하세요 >> ");
